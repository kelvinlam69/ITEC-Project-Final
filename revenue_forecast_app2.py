...
# ---- In-Sample Actual vs. Fitted Revenue ---- 

# 1. Prepare in‐sample exogenous data 
exog_insample = df[["CPI", "store_count"]] 

# 2. Get in‐sample predictions (fitted values) with 95% CI 
...
# 4. If using Streamlit, display with: 

# st.pyplot(fig) 

# Otherwise, to show the plot directly: 
